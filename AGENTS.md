...
- The OSD Patch Codes menu is patched by `decomp/ApplyOsdCheatTogglePatch.ps1`; its Edit / Toggle Cheats row opens a dialog with an `Enable Cheats` switch and an `Edit .pnach` button instead of going straight to the text editor.
