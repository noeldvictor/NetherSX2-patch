...
- The OSD PNACH lookup should agree with the game-list badge lookup: use the native game PNACH path when it exists, then fall back to the visible external app `files/cheats/<CRC>.pnach` path.
